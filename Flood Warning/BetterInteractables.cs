    ...
    class BetterInteractables : BaseUnityPlugin
    {
        ...
        public static bool RunBetterInteractables()
        {
            ...
            for (int i = 0; i <= 20; i++)
            {
                ...
                myRule.tooltipBodyToken = myNum*100 + "% Chance to replace a vanilla triple shop with a custom one";
                if (i == 0f)
                {
            ...
            for (int i = 0; i <= 20; i++)
            {
                ...
                myRule.spritePath = "Textures/MiscIcons/texRuleBonusStartingMoney";
                myRule.tooltipNameToken = "" + myNum * 100 + " Base Chance Per Tier";
            ...
            addCategory.Invoke(null, new object[] { "Better Shrines/Duplicators", new Color(219 / 255, 182 / 255, 19 / 255, byte.MaxValue), "", new Func<bool>(() => false) });
            ...
            RuleDef betterShrineRule = new RuleDef("FloodWarning.betterShrine", "Whether or not the game should have better shrines");
            {
                ...
                myRule2.tooltipBodyToken = "Shrines can be used 2-5 times (Chosen randomly), Duplicators and shrines can be used quicker";
