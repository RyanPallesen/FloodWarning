...
namespace Flood_Warning
{
    class AITeammates : BaseUnityPlugin
    {
        ...
        public static bool RunAITeammates()
        {
            ...
            addCategory.Invoke(null, new object[] { "Item Amount Ratio", new Color(94 / 255, 82 / 255, 30 / 255, byte.MaxValue), "", new Func<bool>(() => false) });
            ...
            for (float o = 0; o <= 20; o++)
            {
                ...
                myRule5.tooltipNameToken = "" + myNum + "to 1";
